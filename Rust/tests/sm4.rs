...
//
// use sm_crypto::sm::{ModeKind, PaddingKind, SmCryptoError};
// use sm_crypto::sm4::{CryptoTrait, Sm4};
//
//
// #[test]
// fn test_sm4_new_ecb_string() {
//   let key = "af32409cf34aeef23f4b328a96100ce1".to_string();
//   let sm4 = Sm4::new(key, PaddingKind::Pkcs7, ModeKind::Ecb, None);
//   assert!(sm4.is_ok());
//   let sm4 = sm4.unwrap();
...
//   let sm4 = Sm4::new(key, PaddingKind::Pkcs7, ModeKind::Cbc, None);
//   assert!(sm4.is_err());
//   assert_eq!(sm4.unwrap_err(), SmCryptoError::InvalidData);
//
//   let key = "af32409cf34aeef23f4b328a96100ce1".to_string();
//   let sm4 = Sm4::new(
//     key, PaddingKind::Pkcs7, ModeKind::Cbc, Some("32ef4500ad3ecb2a34dcb09aac34bf".to_string()),
//   );
//   assert!(sm4.is_err());
//   assert_eq!(sm4.unwrap_err(), SmCryptoError::InvalidData);
//
//   let key = "af32409cf34aeef23f4b328a96100ce1";
//   let sm4 = Sm4::new(
//     key, PaddingKind::Pkcs7, ModeKind::Cbc, Some("32ef4500ad3ecb2a34dcb09aac34bfea"),
//   );
//   assert_eq!(
//     sm4.unwrap().sm4_key,
...
//   let key = "af32409cf34aeef23f4b328a96100ce1".to_string();
//   let sm4 =
//     Sm4::new(key, PaddingKind::Pkcs7, ModeKind::Cbc, Some("32ef4500ad3ecb2a34dcb09aac34bfea".to_string()));
//   assert_eq!(
//     sm4.unwrap().sm4_key,
//     [175, 50, 64, 156, 243, 74, 238, 242, 63, 75, 50, 138, 150, 16, 12, 225]
//   );
...
//   let sm4 = Sm4::new(key, PaddingKind::Pkcs7, ModeKind::Ecb, None).unwrap();
//
...
//   let sm4 = Sm4::new(key, PaddingKind::Pkcs7, ModeKind::Cbc, Some(iv)).unwrap();
//
